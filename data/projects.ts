...
export const projects: Project[] = [
  {
    ...
    stack: ["Next.js", "FastAPI", "PostgreSQL", "pgvector", "RAG", "Docker"],
  ...
  },
  {
    ...
    stack: ["React", "FastAPI", "PostgreSQL", "Leaflet", "SQLAlchemy"],
  ...
  },
  {
    ...
    category: "Applied machine learning", status: "Educational analysis system",
    problem: "A market prediction means little without context and careful evaluation.",
    description: "An educational market-analysis system combining historical data, technical indicators, ML direction predictions, explainability, and leakage-aware backtesting.",
    highlights: ["25 engineered model features", "Walk-forward model evaluation", "Explainability & historical sentiment"],
    stack: ["Python", "XGBoost", "FastAPI", "React", "Recharts", "FinBERT"],
    ...
    considerations: "Chronological train, validation, and test splits, time-series validation, and walk-forward evaluation address the temporal nature of market data. Backtesting accounts for transaction costs and slippage. Predictions are analytical, educational ML outputs, not trading instructions or guarantees of returns.",
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "FastAPI", "PostgreSQL", "Razorpay"],
  ...
  },
  {
    ...
    stack: ["Python", "Scikit-learn", "River", "SciPy", "FastAPI", "React"],
