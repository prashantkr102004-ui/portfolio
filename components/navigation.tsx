  ...
  return (
    <header className="site-header">
      <div className="header-inner">
        <Link href="/" className="brand" aria-label="Prashant Kumar, home">
          <span className="brand-mark">PK</span>
          <span className="brand-name">Prashant Kumar</span>
        </Link>

        <nav aria-label="Main navigation" id="main-navigation" className={menuOpen ? "main-nav is-open" : "main-nav"}>
          {navigation.map((item) => {
