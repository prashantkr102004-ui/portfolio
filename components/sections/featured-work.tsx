...
export function FeaturedWork() {
  ...
  return <section id="work" className="featured-section" aria-labelledby="work-title"><div className="section-heading"><div><span className="eyebrow mono">01 / Featured Work</span><h2 id="work-title">Serious projects, built around real workflows.</h2></div><p>AI/ML, full-stack systems, data pipelines, and product thinking presented as substantial case studies.</p></div>
    ...
    <div className="more-work" id="more-projects" aria-labelledby="more-work-title"><div><span className="eyebrow mono">Explore more projects</span><h3 id="more-work-title">Want to see more of my work?</h3></div><a className="more-work-button" href={profile.github} target="_blank" rel="noreferrer" aria-label="Explore more projects on Prashant Kumar's GitHub">Explore more projects <Arrow diagonal /></a></div>
  </section>;
}
